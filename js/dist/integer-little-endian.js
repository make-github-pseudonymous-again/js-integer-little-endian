...
(function () {
   ...
   */
	...
	if (typeof exports === "object") {
		...
		define("aureooms-js-integer-little-endian", [], function () {
			return definition({});
		});
	} else if (typeof window === "object" && typeof window.document === "object") {
		definition(window["integerlittleendian"] = {});
	} else console.error("unable to detect type of module to define for aureooms-js-integer-little-endian");
})();